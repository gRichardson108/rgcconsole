...
{
    class HolyWarrior : IProfession
    {
        public string Name { get; set; } = "Holy Warrior";
        public Dictionary<AttributeType, float> PrimaryAttributeWeights { get; set; } = new Dictionary<AttributeType, float>
        {
            { AttributeType.ST, 0.12f },
            { AttributeType.DX, 0.24f },
            { AttributeType.IQ, 0.16f },
        ...
        {
            { PowerUps.HigherPurpose, 0.02f },
            { PowerUps.RestInPieces, 0.02f },
        ...
        public Dictionary<Trait, float> DisadvantageWeights { get; set; } = new Dictionary<Trait, float>
        {
            ...
            { FantasyDisadvantages.Charitable, 0.02f },
        ...
        public Dictionary<FantasyGameSkill, float> SkillWeights { get; set; } = new Dictionary<FantasyGameSkill, float>
        {
            ...
            { FantasySkills.Medicine, 0.015f },
            { FantasySkills.Meditation, 0.02f },
            { FantasySkills.Mysticism, 0.03f },
